...
$reg=mysqli_query($con,$tem);
$ro=mysqli_fetch_assoc($reg);
$gee=$ro['tname'];
$x=$_GET['x'];
$_SESSION['pid'] =$x;
...
$deity=$col['deity'];
$ml="select dname,did from deity where did=$deity;";
     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="AddPoojaR.php">Add Pooja</a></li>
            <li><a href="AdminPoojaListR.php">View Pooja List</a></li>
			<li><a href="PendingPoojaR.php">Pending Poojas</a></li>
			<li><a href="completedPoojaR.php">Completed Poojas</a></li>
		  ...
		  <div class="box-header">
			...
			<div class="tab-content">
              <div class="tab-pane active">
               <form action="EditPoojaR1.php" method="post" class="form-horizontal">
				  <div class="form-group">
					<label class="col-sm-3 control-label">Deity</label>
					<div class="col-sm-6">
					 <select name="deity" id="deity" class="form-control">	
					 <option value="<?php echo $d['did']; ?>" selected><?php echo $d['dname']; ?></option>  
					<?php		
					
						$con=mysqli_connect("localhost","geethu","geethu@21","temple");
						
						$sel="select dname,did from deity where tid=$templeid";
						$det=mysqli_query($con,$sel);
						if($det->num_rows >0){
						$areaOptions = "";
							while($row=$det->fetch_assoc()){			
							
							$areaOptions .= '<option value="' . $row['did'] . '">' . $row['dname'] . '</option>';
