	...
	function del(x){
		var i=x;
				...
				if(confirm("Are You Sure??")){
						var url="poojadelR.php?x="+i;
					window.location.href=url;
				}
				else{
					
					window.location.href='location:AdminPoojaListR.php';
				}
	}
  </script>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="AdminPoojaListR.php">View Pooja List</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT pj.pid,tmp.tname,dt.dname,pj.pname,pj.purpose,pj.amount FROM 
									...
									left outer join deity dt on pj.deity=dt.did where tname='$gee'";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["pid"]. "</td><td>" .$row["dname"]. "</td><td>" .$row["pname"]. "</td><td>" .$row["purpose"]. "</td><td>" .$row["amount"]. "</td> ";
									echo "<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Collapse' onclick=window.location.href='EditPoojaR.php?x=". $row["pid"]. "'>
									<i class='fa fa-pencil' ></i></button>
									<button type='button' class='btn btn-info btn-sm' name='delete' data-toggle='tooltip'
									title='Remove' onclick='del(". $row["pid"]. ");'>
