...
$x=$_GET['x'];
$_SESSION['prid'] =$x;
$sql="select * from priest where prid=$x";
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Priest Details</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="AddPriest.php">Add</a></li>
            <li><a href="AdminPriestList.php">View Priest Details</a></li>
          </ul>
        </li>
		...
		<div class="box">
		  <div class="box-header">
				<div class="nav-tabs-custom">
					<h2 align="center">Edit Priest</h2>
				</div>
				<div class="tab-content">
				<div class="tab-pane active">
				<form action="EditPriest1.php" method="post" class="form-horizontal">
				  ...
				  <div class="form-group">
					<label class="col-sm-3 control-label">Priest Name</label>
                  <div class="col-sm-6">
                   <input type="text" name="txtname" class="form-control" placeholder="Enter ..." required value="<?php echo $col['pname']; ?>">
                  </div>
				  </div>
				  ...
				  <div class="col-sm-6">
                  <textarea class="form-control" name="txtadr" rows="3" placeholder="Enter ..." required><?php echo $col['adrs']; ?></textarea>
				  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
              <input type="email" name="txtemail" class="form-control" placeholder="Enter ..." required value="<?php echo $col['email']; ?>">
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="number" name="txtmob" class="form-control" placeholder="Enter ..." required value="<?php echo $col['mob']; ?>">
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="date" name="date" class="form-control" placeholder="Enter ..." required value="<?php echo $col['doj']; ?>">
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="number" name="txtsal" class="form-control" placeholder="Enter ..." required value="<?php echo $col['salary']; ?>">
                  </div>
				  </div>
