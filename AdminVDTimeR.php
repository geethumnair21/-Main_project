	...
	function del(x){
		var i=x;
				...
				if(confirm("Are You Sure??")){
						var url="timedelR.php?x="+i;
					window.location.href=url;
				}
				else{
					
					window.location.href='location:AdminVDTimeR.php';
				}
	}
  </script>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="AdminVDTimeR.php">View</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT * from time where temple='$gee';";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["tid"]. "</td><td>" .$row["festival"]. "</td><td>" .$row["fdate"]. "</td><td>" .$row["tdate"]. "</td><td>" .$row["time"]. "</td><td>" .$row["event"]. "</td>";
									echo "<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Collapse' onclick=window.location.href='EditTimeR.php?x=". $row["tid"]. "'>
									<i class='fa fa-pencil' ></i></button>
									<button type='button' class='btn btn-info btn-sm' name='delete' data-toggle='tooltip'
									title='Remove' onclick='del(". $row["tid"]. ");'>
