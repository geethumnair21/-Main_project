		...
		<div class="box">
		  <div class="box-header">
				<div class="nav-tabs-custom">
					<h2 align="center">Add Priest</h2>
				</div>
				<div class="tab-content">
				<div class="tab-pane active">
				<form action="AddPriest1.php" method="post" class="form-horizontal">
				  ...
				  <div class="col-sm-6">
                  <textarea class="form-control" name="txtadr" rows="3" placeholder="Enter ..." required></textarea>
				  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="email" name="txtemail" class="form-control" placeholder="Enter ..." required>
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="number" name="txtmob" class="form-control" placeholder="Enter ..." required>
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="date" name="date" class="form-control" placeholder="Enter ..." required>
                  </div>
				  </div>
                  ...
                  <div class="col-sm-6">
                   <input type="number" name="txtsal" class="form-control" placeholder="Enter ..." required>
                  </div>
				  </div>
