              ...
              <div class="tab-pane active">
               <form action="AddPooja1.php" method="post" class="form-horizontal">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
                   <input type="text" name="txtpooja" class="form-control" placeholder="Enter ...">
                  </div>
					<label class="col-sm-1 control-label">Amount</label>
				<div class="col-sm-2">
                   <input type="text" name="txtamount" class="form-control" placeholder="Enter ...">
                 </div>
                </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-6">
                  <textarea class="form-control" name="txtpurpose" rows="3" placeholder="Enter ..."></textarea>
				  </div>
                </div>
