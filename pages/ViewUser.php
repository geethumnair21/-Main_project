    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="ViewUser.php">View User Profile</a></li>
            <!-- <li><a href="#">Link in level 2</a></li> -->
          </ul>
        </li>
      </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li class="fa fa-dashboard">User Profile</li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View User Profile</h3>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT name,gender,dob,address,email,mob,curdate from registration";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["name"]. "</td><td>" .$row["gender"]. "</td><td>" .$row["dob"]. "</td><td>" .$row["address"]. "</td><td>" .$row["email"]. "</td><td>" .$row["mob"]. "</td><td>" .$row["curdate"]. "</td></tr>";
									} 
