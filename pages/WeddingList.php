        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View Wedding List</h3>
            </div>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT w.cid,w.temple,w.wdate,b.wid,b.bname,b.gname,b.uid,b.cid from W_check w 
								  left outer join W_booking b on w.cid=b.cid where uid=b.uid;";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["uid"]. "</td><td>" .$row["temple"]. "</td><td>" .$row["wdate"]. "</td><td>" .$row["bname"]. "</td><td>" .$row["gname"]. "</td>";
									$x=$row["wid"];
									echo "<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='View' onclick=window.location.href='ViewWdetails.php?wid=".$row['wid']."'>
