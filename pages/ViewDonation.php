    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="ViewDonation.php">View Donation List</a></li>
            <!-- <li><a href="#">Link in level 2</a></li> -->
          </ul>
        </li>
		<li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li class="fa fa-dashboard">Donation</li>
		<li class="active">View Donation List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View Donation List</h3>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				 ...
				 <?php
								...
								$sel="SELECT uid,name,temple,amount,purpose,curdate from donation";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["uid"]. "</td><td>" .$row["name"]. "</td><td>" .$row["temple"]. "</td><td>" .$row["purpose"]. "</td><td>" .$row["amount"]. "</td><td>" .$row["curdate"]. "</td></tr>";
									} 
