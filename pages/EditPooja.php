...
$x=$_GET['x'];
$_SESSION['pid'] =$x;
$sql="select * from pooja where pid=$x";
$res=mysqli_query($con,$sql);
$col=mysqli_fetch_assoc($res);
$tname=$col['temple'];
$sq="select tname from temple where tid=$tname;";
$re=mysqli_query($con,$sq);
$c=mysqli_fetch_assoc($re);
$deity=$col['deity'];
$ml="select dname from deity where did=$deity;";
$ab=mysqli_query($con,$ml);
$d=mysqli_fetch_assoc($ab);
?>
...
<script type='text/javascript'>
	  ...
	  function changeData()
	  {
		  document.getElementById("categoriesSelect").style.display="block";
		  document.getElementById("txttemple").style.display="none";
		  document.getElementById("subcatsSelect").style.display="block";
		  document.getElementById("txtdeity").style.display="none";
	  }
    </script>
		...
		<div class="box">
		  <div class="box-header">
				<div class="nav-tabs-custom">
					<h2 align="center">Edit Pooja</h2>
				</div>
					
			<div class="tab-content">
              <div class="tab-pane active">
               <form action="EditPooja1.php" method="post" class="form-horizontal">
                  ...
                  <label class="col-sm-3 control-label">Temple</label>
					...
					echo' <div class="col-sm-6">		
                          <select id="categoriesSelect" name="temple" class="form-control" style="display:none;">
					...
					echo'<div class="col-sm-6">		
                     <input type="text" id="txttemple" name="txttemple" class="form-control" placeholder="Enter ..." value="'.$c['tname'].'">
				</div>';
						
				
					?>
					
					<input type="button" value="Edit" name="edit" onclick="changeData()">	
                  </div>
				  <div class="form-group">
					...
					echo' <div class="col-sm-6">
                   <select id="subcatsSelect" name="deity" class="form-control" style="display:none;">
					...
					echo'<div class="col-sm-6">		
                     <input type="text" id="txtdeity" name="txtdeity" class="form-control" placeholder="Enter ..." value="'.$d['dname'].'">
				</div>';
