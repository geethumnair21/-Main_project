    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="ViewFeedback.php">View User Feedback</a></li>
            <!-- <li><a href="#">Link in level 2</a></li> -->
          </ul>
        </li>
		<li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li class="fa fa-dashboard">Feedback</li>
		<li class="active">View User Feedback</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View User Feedback</h3>
            </div>
                ...
                <tr>
				 ...
				 <?php
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["email"]. "</td><td>" .$row["temple"]. "</td><td>" .$row["feedback"]. "</td></tr>";
									} 
