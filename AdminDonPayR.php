      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="AdminDonPayR.php">Payment List</a></li>
            <!-- <li><a href="#">Link in level 2</a></li> -->
          </ul>
        </li>
		<li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li class="fa fa-dashboard">Donation Details</li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">Payment List</h3>
            </div>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT * from paymentdon";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["pyid"]. "</td><td>" .$row["did"]. "</td><td>" .$row["uid"]. "</td><td>" .$row["price"]. "</td><td>" .$row["total"]. "</td><td>" .$row["curdate"]. "</td>
