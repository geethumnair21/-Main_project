        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">View Priest List</h3>
            </div>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT * from priest";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["prid"]. "</td><td>" .$row["temple"]. "</td><td>" .$row["pname"]. "</td><td>" .$row["adrs"]. "</td><td>" .$row["email"]. "</td><td>" .$row["mob"]. "</td><td>" .$row["doj"]. "</td><td>" .$row["salary"]. "</td> ";
									echo "<td><div class='box-tools'>
									<button type='button' class='btn btn-info btn-sm'  data-toggle='tooltip' title='Collapse' onclick=window.location.href='EditPriest.php?x=". $row["prid"]. "'>
									<i class='fa fa-pencil' ></i></button>
									<button type='button' class='btn btn-info btn-sm' name='delete' data-toggle='tooltip'
									title='Remove' onclick=window.location.href='priestdel.php?x=". $row["prid"]. "'>
