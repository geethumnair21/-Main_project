		  ...
		  <div class="box-header">
			...
			<div class="tab-content">
              <div class="tab-pane active">
               <form action="EditTimeR1.php" method="post" class="form-horizontal">
             ...
             <input type="text" name="txtfest" class="form-control" placeholder="Enter ..." required value="<?php echo $col['festival']; ?>">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <input type="date" name="fdate" class="form-control" required value="<?php echo $col['fdate']; ?>">
                  </div>
				  <label class="col-sm-1 control-label">To</label>
                  <div class="col-sm-2">
					<input type="date" name="tdate" class="form-control" required value="<?php echo $col['tdate']; ?>">
				  </div>
				  </div>
				  <div class="form-group">
