      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="AdminPoojaPayR.php">Payment List</a></li>
          </ul>
        </li>
			...
			<div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT * from paymentpooja";
								$res=mysqli_query($con,$sel);
							
								if(mysqli_num_rows($res)>0){
									while($row=$res->fetch_assoc()){
									
									echo "<tr><td>". $row["pyid"]. "</td><td>" .$row["pid"]. "</td><td>" .$row["uid"]. "</td><td>" .$row["price"]. "</td><td>" .$row["total"]. "</td><td>" .$row["curdate"]. "</td>
