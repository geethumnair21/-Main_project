      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="PendingPoojaR.php">Pending Poojas</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 align="center">Booked Pooja List</h3>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
								...
								$sel="SELECT tmp.tname,dt.dname,p.name,p.uid,p.bid,p.star,p.date,p.status,pj.pname,pj.amount FROM 
                                   ...
                                   left outer join p_booking p on pj.pid=p.pid where uid=p.uid and p.status=0 and tname='$gee';";
								...
								if(mysqli_num_rows($res)>0){
									...
									echo "<tr><td>". $row["uid"]."</td><td>". $row["dname"]."</td><td>". $row["name"]."</td><td>". $row["star"]."</td><td>". $row["date"]."</td><td>". $row["pname"]."</td><td>". $row["amount"]."</td>";
									$x=$row["bid"];
