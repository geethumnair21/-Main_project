      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="AddDarshanTimeR.php">Add</a></li>
		...
		<div class="box">
		  <div class="box-header">
				<div class="nav-tabs-custom">
					<h2 align="center">Add Darshan Time</h2>
				</div>
					
			<div class="tab-content">
              <div class="tab-pane active">
               <form action="AddDarshanTimeR1.php" method="post" class="form-horizontal">
				 
				<div class="form-group">
					<label class="col-sm-3 control-label">Festival</label>
                  <div class="col-sm-6">
                   <input type="text" name="txtfest" class="form-control" placeholder="Enter ..." required>
                  </div>
                </div>
				<div class="form-group">
				  ...
				  <div class="col-sm-6">
                   <input type="text" name="txttime" class="form-control" placeholder="Enter ..." required>
                  </div>
                </div>
				 <div class="form-group">
					<label class="col-sm-3 control-label">Event</label>
						<div class="col-sm-6">
                   <input type="text" name="txtevent" class="form-control" placeholder="Enter ..." required>
						</div>
					</div>
				<div class="col-md-12">
				<div class="form-group">
